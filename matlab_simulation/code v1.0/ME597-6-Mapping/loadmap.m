function [map, x, traj]=loadmap(mapNum)
% Creates and returns a 2D map used for robotic simulations
% Input:
% 	mapNum = Number of map to return
% 		0 = Default map, smaller map with mostly empty space and some blocks, 
%			size: (50 x 60)
% 		1 = Map with lots of scatttered obstacles, size: (100 x 100)
