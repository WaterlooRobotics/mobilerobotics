...
% Redefine environment to include more obstacles and a simpler boundary
b = [0 0; 30 0; 30 30; 0 30];
o{1} = [3 14; 3 16; 8 16; 8 14];
o{2} = [12 14; 12 16; 18 16; 18 14];
o{3} = [21 14; 21 16; 27 16; 27 14];
o{4} = [20 24; 22 24; 24 26; 26 24; 24 28];
o{5} = [10 0; 10 10; 20 10; 20 0]; 
o{6} = [30 20; 25 20; 25 22; 30 22]; 
o{7} = [15 30; 15 22; 13 22; 13 30];
o{8} = [5 20; 5 22; 20 22; 20 20];
numObsts = length(o);
