...
p_occ = 0.7; % Probability for occupied cells
p_free = 0.3 % Probability for free cells
...
m = inversescanner(M,N,x,y,theta,meas_phi,meas_r,rmax,alpha,beta, p_occ, p_free);
