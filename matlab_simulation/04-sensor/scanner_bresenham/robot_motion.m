...
%% Randomly generate robot x & y velocities 
 ...
 while (x_vel * y_vel == 0) % Change x and y velocities in case at least one of them is zero 
 ...
 for t = 2:T+1  
    % Judge which mode should be used at current loop
      mode = collision_pred( t, X, x_vel, y_vel, map ); 
