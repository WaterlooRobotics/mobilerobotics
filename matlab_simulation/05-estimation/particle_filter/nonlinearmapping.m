...
linear = 0; % if 1, run the linear transformation, else the nonlinear one
...
if (linear)
    yN = 3*x+0.5; % Nonlinear transformation of pdf
    yNS = 3*xS+0.5; % Nonlinear transformation of samples
end
...
plot(0.001*ones(1,length(Y)),Y, 'co', 'MarkerSize', 8, 'LineWidth', 2);
