function map = maze(row,col,pattern)
% usage  map = maze(30,45,'c');
...
map = show_maze(row, col, rr, cc, ptr_left, ptr_up, ptr_right, ptr_down,h);
return


function map = show_maze(row, col, rr, cc, ptr_left, ptr_up, ptr_right, ptr_down,h)
figure(h)
map = [.5,col+.5,.5,.5];
